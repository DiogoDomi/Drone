...
// Inclluir o SSID e PASSWORD da sua rede local
const char *STA_SSID = "SSID";
const char *STA_PSWD = "PASSWORD";
} // namespace

WiFiManager::WiFiManager() : m_rssiData(Flags::WIFI_RSSI_INVALID) {}
...
void WiFiManager::setupSTA() { WiFi.begin(STA_SSID, STA_PSWD); }
